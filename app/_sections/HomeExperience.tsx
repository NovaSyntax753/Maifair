        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {pillars.map((p, i) => (
            <AnimatedSection key={p.title} delay={i * 0.15} className="text-center group">
              <div className="relative bg-[#0a0a0a] border border-[rgba(201,168,76,0.15)] p-10 flex flex-col items-center gap-5 hover:border-[rgba(201,168,76,0.4)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_12px_48px_rgba(0,0,0,0.5)]">
                {/* Gold corner */}
                ...
                {/* Icon circle */}
                <div className="w-16 h-16 rounded-full border border-[rgba(201,168,76,0.3)] flex items-center justify-center group-hover:border-[#c9a84c] group-hover:shadow-[0_0_20px_rgba(201,168,76,0.15)] transition-all duration-400">
                  {p.icon}
                </div>
